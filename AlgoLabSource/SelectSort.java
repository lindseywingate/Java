class SelectSort extends DecisionAlgorithm
 {
    int [] intset;
    long stepcount = 0;
    int numcount = 0;
    ...
    {
       int nextvalue, pos;
       for (int current=0; current<numcount; current++)
       {
          int temp = intset[current];
          int minpos = findMinIndex(current, numcount-1);
          intset[current] = intset[minpos];
          intset[minpos] = temp;
      }
    }
